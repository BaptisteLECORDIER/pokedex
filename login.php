...
<header>
    ...
    <form method="POST" class="form" action="./modules/controllers/forms/login.php">
      <div>
        <div class="align">
          <h1 class="fs-1">Se connecter</h1>
        </div>
        ...
        <div class="align">
          <a href="./modules/controllers/forms/logout.php">Se déconnecter</a>
